                                                            ...
                                                            while Times3!=44:
                                                                ...
                                                                while Times!=44:
                                                                    ...
                                                                    while Times2!=44:
                                                                        ...
                                                                        if Calculus[Times:Times+4]==Calculus[Times2:Times2+4] and Calculus[Times:Times+4]==Calculus[Times3:Times3+4] and Combination1<=(2**46) and res8==0 and  Times2!=Times and Times!=Times2 and Times!=Times3 and long2==blocks  and Times<=Times2+8 and Times2<=Times3+8 and Times+8>=Times2 and Times2+8>=Times3:
                                                                            Combination1+=1
                                                                        ...
                                                                        elif Calculus[Times:Times+4]==Calculus[Times2:Times2+4] and Calculus[Times:Times+4]==Calculus[Times3:Times3+4] and Combination2==Calculus and res7==0 and  Times2!=Times and Times!=Times2 and Times!=Times3 and   long2==blocks and Times<=Times2+8 and Times2<=Times3+8 and Times+8>=Times2 and Times2+8>=Times3 and Combination1!=2**46 and res5==0 and res1==0:
                                                                ...
                                                                while Times3!=44:
                                                                    ...
                                                                    while Times!=44:
                                                                        ...
                                                                        while Times2!=44:
                                                                            ...
                                                                            if Combination2[Times:Times+4]==Combination2[Times2:Times2+4] and Combination2[Times:Times+4]==Combination2[Times3:Times3+4] and  Combination1<=(2**46) and res10==0 and  Times2!=Times and Times!=Times2 and Times!=Times3 and long2==blocks  and Times<=Times2+8 and Times2<=Times3+8 and Times+8>=Times2 and Times2+8>=Times3:
                                                                                Combination1+=1
                                                                                Combination3=format(Combination1,'046b')
                                                                            ...
                                                                            elif Combination2[Times:Times+4]==Combination2[Times2:Times2+4] and Combination2==Combination3 and Combination2[Times:Times+4]==Combination2[Times3:Times3+4] and Caculus==Combination2 and res1==0 and  Times2!=Times and Times!=Times2 and Times!=Times3 and   long2==blocks and Times<=Times2+8 and Times2<=Times3+8 and Times+8>=Times2 and Times2+8>=Times3 and Combination1!=2**46 and res5==0 and res1==0:
